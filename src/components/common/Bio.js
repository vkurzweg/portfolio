      ...
      <div id="bio" style={{ width: '100%', backgroundColor: '#212121', color: '#FAFAFA', textAlign: 'center', fontSize: '16px' }}>
        <div style={{ display: 'inline-flex', width: '100%' }}>
          ...
          <div style={{ marginTop: '6%', marginLeft: '3%' }}>
            <p style={{ fontSize: '14px', textAlign: 'left', marginRight: '5%', marginBottom: '2%' }}>Hello I'm Victoria Kurzweg, a web developer and designer based in West Hollywood. Before pivoting to tech in 2016, I worked in sales, international search marketing, journalism and public affairs. I hold a master's degree in history of international relations from the London School of Economics.</p>
